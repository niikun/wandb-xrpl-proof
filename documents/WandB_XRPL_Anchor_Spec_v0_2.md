...
This specification defines a standardized method for anchoring
Weave-traced W&B runs to the XRPL blockchain using canonical hashing and
...
Anchoring MAY occur: - Per Weave Op call - At evaluation-only ops - Once
at run completion
